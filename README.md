...
- **Resume schema drift fails closed**: if the recorded and newly computed MD resume-gate payloads disagree on non-runtime key presence, resume is denied instead of silently comparing only shared keys.
